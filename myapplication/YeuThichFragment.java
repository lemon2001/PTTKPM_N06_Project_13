...
import com.example.myapplication.adapter.adapterTintucYeuThich;
...
public class YeuThichFragment extends Fragment {
    ...
    adapterTintucYeuThich adapterTintuc;
    ...
    private void DialogDeleteYeuThic(int position) {
        ...
        btnYes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int idtruyen = tinArraylist.get(position).getID();
                //Xóa trong SQL
    ...
    private void AnhXa()
    {
        ...
        Cursor cursor1 = database.getData4();
        ...
        adapterTintuc =new adapterTintucYeuThich(getContext(), tinArraylist);
        listViewNew.setAdapter(adapterTintuc);
        cursor1.moveToFirst();
        cursor1.close();
