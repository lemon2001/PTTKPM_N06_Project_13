...
public class MainActivity extends AppCompatActivity {
    ...
    public void init(){
        ...
        menuItems.add(new MenuItem("Tạo công thức",R.drawable.feed_bg));
        menuItems.add(new MenuItem("Món ăn yêu thích",R.drawable.message_bg));
        menuItems.add(new MenuItem("Tất cả món ăn",R.drawable.music_bg));
        menuItems.add(new MenuItem("Thông tin app",R.drawable.music_bg));
        ...
        sNavigationDrawer.setOnMenuItemClickListener(new SNavigationDrawer.OnMenuItemClickListener() {
            ...
            public void onMenuItemClicked(int position) {
                ...
                switch (position){
                    ...
                    case 3:{
                        fragmentClass = TatcatintucFragment.class;
                        break;
                    }
                    case 4:{
