...
public class thongtinappFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String thongtin = " App Quản lý công thức nấu ăn là một ứng dụng thông minh và tiện lợi, được thiết kế để giúp người dùng theo dõi và cập nhật được nhiều công thức nấu ăn khác nhau \n" +
